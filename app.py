...
<div style="display: flex; flex-direction: column;">
    ...
    <a class="btn-custom-menu" href="https://lattes.cnpq.br/" target="_blank"><span><img src="https://biblioteca.pucrs.br/wp-content/uploads/2022/02/curriculo-lattes.png"width: 5px; height: 5px; margin-right: 10px; border-radius: 3px; object-fit: cover;"><span>Currículo Lattes</span></a>
