...
<div style="display: flex; flex-direction: column;">
    ...
    <a class="btn-custom-menu" href="https://scispace.com/" target="_blank"><img src="https://typeset.io/favicon.ico" style="width: 16px; height: 16px; margin-right: 10px; border-radius: 2px;"><span>SciSpace</span></a>
        <a class="btn-custom-menu" href="https://elicit.com/" target="_blank"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS52Ne-xLXdUoxAL4OrJfc9dk5RNyA0BftiRtKylh3pK7zz5PbO7YDr1k4M&s=10" style="width: 16px; height: 16px; margin-right: 10px; filter: brightness(0) invert(1);">
        <span>Elicit</span></a>   
