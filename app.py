...
<div style="display: flex; flex-direction: column;">
    ...
    <a class="btn-custom-menu" href="https://scispace.com/" target="_blank"><img src="https://typeset.io/favicon.ico" style="width: 16px; height: 16px; margin-right: 10px; border-radius: 2px;"><span>SciSpace</span></a>
        <a class="btn-custom-menu" href="https://elicit.com/" target="_blank"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQDFHl4vR2gL1q4KY2ESSUPtRncD1BmAm__YmFGHl5Ptw&s=10" style="width: 16px; height: 16px; margin-right: 10px; filter: brightness(0) invert(1);">
        <span>Elicit</span></a>   
