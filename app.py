...
if imagem_base64:
    tag_imagem = f'<img src="data:image/jpeg;base64,{imagem_base64}" style="height: 180px; width: auto; object-fit: contain;">'
else:
...
"""
    ...
    expander_titulo = "📖 Sobre SciPub y Cómo Utilizar"
    sobre_texto = """
### ¡Bienvenido a SciPub - El Portal del Investigador!
